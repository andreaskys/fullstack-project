...
export default function CreateListingPage() {
    ...
    const removeImage = (urlToRemove: string) => {
        ...
        // TODO: Chamar o backend para apagar o ficheiro do MinIO
    };
    ...
    if (isLoading) return <main className="p-8 text-gray-900">A carregar...</main>;
    ...
    return (
        <main className="min-h-screen bg-gray-100 p-8">
            ...
            <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
                ...
                <h1 className="text-3xl font-bold mb-8 text-gray-900">Criar Novo Espaço</h1>
